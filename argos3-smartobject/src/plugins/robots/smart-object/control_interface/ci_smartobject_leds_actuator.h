/**
 * @file <argos3/plugins/robots/object/control_interface/ci_smartobject_leds_actuator.h>
 */

#ifndef CCI_SMARTOBJECT_LEDS_ACTUATOR_H
#define CCI_SMARTOBJECT_LEDS_ACTUATOR_H

namespace argos {
   class CCI_SmartObjectLEDsActuator;
}
...
namespace argos {
   ...
   class CCI_SmartObjectLEDsActuator : public CCI_Actuator {
   ...
   public:
      ...
      CCI_SmartObjectLEDsActuator() {}

      virtual ~CCI_SmartObjectLEDsActuator() {}
